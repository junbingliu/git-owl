...
(function ($) {
    ...
    var IsonePagination = function (e) {
        ...
        var _enableToPage = false; //是否显示跳转到页面
        ...
        if (this.elem.attr("enableToPage") && this.elem.attr("enableToPage") == "true") {
            _enableToPage = true;
        }
        ...
        if (_enableToPage && _totalPages > _displayNum) {
            re += "<li class='disabled'><a href='#'>跳转到第</a></li>";
