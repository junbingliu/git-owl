...
//								$('<a href="#" class="selecteee">aaa</a>'),
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										$('<div class="datePicker_nav"><a class="dp-nav-prev-year first" href="#" title="' + $.dpText.TEXT_PREV_YEAR + '">«</a></div>')
											.bind(
												'click',
												function()
												{
										...
										$('<div class="datePicker_nav"><a class="dp-nav-prev-month previous" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '">‹</a></div>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
                                        $('<div class="datePicker_nav" style="margin-left: 52px;"><a class="dp-nav-next-month next" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '">›</a></div>')
                                            .bind(
                                            'click',
                                            function()
                                            {
										...
										$('<div class="datePicker_nav"><a class="dp-nav-next-year last" href="#" title="' + $.dpText.TEXT_NEXT_YEAR + '">»</a></div>')
											.bind(
												'click',
												function()
												{
